 ...
 *     constrain="App\Core\Component\Blog\Infrastructure\Persistence\Post\Scope\PublicScope"
 * )
 * @Table(
 *     indexes={
...
class Post
{
    ...
    /**
     * @ManyToMany(target="App\Core\Component\Blog\Domain\Tag", though="PostTag", fkAction="CASCADE")
     *
