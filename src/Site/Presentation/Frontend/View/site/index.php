    ...
    <div>
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home"
                        ...
                        aria-selected="true"><?= $translator->translate('view-site.home') ?></button>
                <button class="nav-link" id="nav-migration-tab" data-bs-toggle="tab" data-bs-target="#nav-migration"
                        type="button" role="tab" aria-controls="nav-home"
                        aria-selected="true"><?= $translator->translate('view-site.migrations') ?></button>
                <button class="nav-link" id="nav-rbac-tab" data-bs-toggle="tab" data-bs-target="#nav-rbac" type="button"
                        role="tab" aria-controls="nav-profile"
                        aria-selected="false"><?= $translator->translate('view-site.rbac') ?></button>
                <button class="nav-link" id="nav-user-tab" data-bs-toggle="tab" data-bs-target="#nav-user" type="button"
                        role="tab" aria-controls="nav-profile"
                        aria-selected="false"><?= $translator->translate('view-site.users') ?></button>
                <button class="nav-link" id="nav-db-schema-tab" data-bs-toggle="tab" data-bs-target="#nav-db-schema"
                        type="button" role="tab" aria-controls="nav-contact"
                        aria-selected="false"><?= $translator->translate('view-site.db.schema') ?></button>
                <button class="nav-link" id="nav-other-tab" data-bs-toggle="tab" data-bs-target="#nav-other"
                        type="button" role="tab" aria-controls="nav-contact"
                        aria-selected="false"><?= $translator->translate('view-site.other') ?></button>
            </div>
        </nav>
        <div class="tab-content border border-1 border-top-0 card-body" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <h4 class="card-title text-muted mt-2 mb-1"><?= $translator->translate('view-site.add.random.content',
                    ) ?></h4>
                <div>
                    <code><?= "{$binPath} fixture/add [count = 10]" ?></code>
                </div>
                <h4 class="card-title text-muted mt-2 mb-1"><?= $translator->translate('view-site.add.admin.backend',
                    ) ?></h4>
                <div>
            ...
            <div class="tab-pane fade" id="nav-rbac" role="tabpanel" aria-labelledby="nav-contact-tab">
                <h4 class="card-title text-muted mt-2 mb-1"><?= $translator->translate('view-site.assignments.list',
                    ) ?></h4>
                <div>
                    <code><?= "{$binPath} assign/assignmentsList" ?></code>
                </div>
                <h4 class="card-title text-muted mt-2 mb-1"><?= $translator->translate('view-site.access.rights.list',
                    ) ?></h4>
                <div>
                    <code><?= "{$binPath} access/list" ?></code>
                </div>
                <h4 class="card-title text-muted mt-2 mb-1"><?= $translator->translate('view-site.user.assignments',
                    ) ?></h4>
                <div>
                ...
                <h4 class="card-title text-muted mt-2 mb-1"><?= $translator->translate('view-site.access.rights.management',
                    ) ?></h4>
                <div>
                ...
                <h4 class="card-title text-muted mt-2 mb-1"><?= $translator->translate('view-site.assign.and.revoke.access.rights',
                    ) ?></h4>
                <div>
            ...
            <div class="tab-pane fade" id="nav-user" role="tabpanel" aria-labelledby="nav-contact-tab">
                <h4 class="card-title text-muted mt-2 mb-1"><?= $translator->translate('view-site.create.and.delete.user',
                    ) ?></h4>
                <div>
